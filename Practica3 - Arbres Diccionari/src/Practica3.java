...
public class Practica3 {
	...
	public static void main(String[] args) {
		...
		String pathFile = classpathRoot +"\\Practica3 - Arbres Diccionari\\src\\Doc1.txt";
...
//		System.out.println(content);
		...
		StringTokenizer st = new StringTokenizer(content, "():.,; \t\n\r\f");
	     while (st.hasMoreTokens()) {
			...
			pathFile = classpathRoot +"\\Practica3 - Arbres Diccionari\\src\\Excl.txt";
			...
			// Establir l'ordre lexicog�fic descendent
			...
			System.out.println(""+ arbre.toString());
		     ...
		     // TEST: No s�ha invocat el m�tode iniInordre
			 ...
			 Comparable<String> c = null;
				 ...
				 System.out.println("---EXCEP 2 ---");
					try {
						arbre.segInordre();
						 ...
						 System.out.println("No s�ha invocat el m�tode iniInordre abans del m�tode segInordre");
					}
				...
				// Soluci�: cridar abans  arbre.iniInordre();
				try {
					c = arbre.segInordre();
				} catch (ArbreException e1) {
					System.out.println(e1.getMessage());
				...
				// TODO Excepci�: l�arbre s�ha modificat abans d�acabar el recorregut
				try {
